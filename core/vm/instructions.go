...
func opCreate(instr instruction, pc *uint64, env Environment, contract *Contract, memory *Memory, stack *stack) {
	...
	// Push new item to the stack based on the returned error (and phase)
	// If everything was successfull and no error was returned the address
	// of the created contract is pushed to the stack, otherwise 0.
