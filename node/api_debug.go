...
// DebugPrivateApi is the collection of debugging related API methods exposed
// only over a secure RPC channel.
type DebugPrivateApi struct {
...
func (api *DebugPrivateApi) Verbosity(level int) {
	glog.SetV(level)
}

// DebugPublicApi is the collection of debugging related API methods exposed over
...
func (api *DebugPublicApi) Metrics(raw bool) (map[string]interface{}, error) {
