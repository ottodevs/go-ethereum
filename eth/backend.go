...
func (s *Ethereum) Apis() rpc.Apis {
	return rpc.Apis{
		&rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   NewEthService(s),
			Public:    true,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   NewAccountService(s.AccountManager()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "personal",
			Version:   "1.0",
			Service:   NewPersonalService(s.AccountManager()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   core.NewBlockChainService(s.BlockChain(), s.AccountManager()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   core.NewTransactionPoolService(s.TxPool(), s.ChainDb(), s.BlockChain(), s.AccountManager()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   miner.NewMinerService(s.Miner()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
			Service:   downloader.NewDownloaderService(s.Downloader()),
			Public:    true,
		}, &rpc.Api{
			Namespace: "miner",
			Version:   "1.0",
			Service:   NewMinerManagementService(s),
			Public:    false,
		}, &rpc.Api{
			Namespace: "txpool",
			Version:   "1.0",
			Service:   NewTxPoolService(s),
			Public:    false,
		}, &rpc.Api{
			Namespace: "eth",
			Version:   "1.0",
